function callFlickrApi(data, callback) {
...
function callIpwhoisApi(data, callback) {
	var xmlhttp0;
...
callIpwhoisApi(data, function(data) {

	callFlickrApi(data, function(data) {
